                        ...
                        <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6">
                                    </i><b>Administrasi Penyelesaian Perkara dan Bindalmin</b></div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: .7rem;">
                                                ...
                                                <button type="button" class="mb-2 mr-2 btn-pill btn btn-warning link1" data-id="1"><i class="fa fa-link"> </i> Link Eviden</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: .7rem;">
                                                <button class="mb-2 mr-2 btn-pill btn btn-warning link7" data-id="7"><i class="fa fa-link"> </i> Link Eviden</button>
