                        ...
                        <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6">
                                    </i><b>Administrasi Perkara, Persidangan, dan Bindalmin</b></div>
                                ...
                                <table class="mb-0 table " id="tabelRiwayatLKE">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td id="temuan1">
                                                <?php
                                                $query = ("select * from bidang where semester = $semester");
                                                $result = mysqli_query($hawasbid, $query);
                                                if ($result) {
                                                    ...
                                                    echo "There was an error: " . mysqli_error($hawasbid);
                                                }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Penetapan Majelis Hakim, Penetapan Panitera Pengganti, Penetapan Hari Sidang
                                            </td>
                                            <td>
                                                -
                                            </td>
...
<script>
    $(".link1").click(function() {
        ...
        $("#idkl").val(ids);
        var temuan1 = currentRow.find("td:eq(1)").text();
        $("#temuan").val(temuan1);
        $('#myModal').modal('show');
    });
